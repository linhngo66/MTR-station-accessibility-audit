...
exit_counts['district_exit_percent'] = exit_counts['exit_count'] / exit_counts['district_exit_counts']
exit_counts.drop(columns=['exit_count', 'district_exit_counts'], inplace=True)
```
...
indices = ['station_no', 'station_code', 'station_name_en', 'area', 'long', 'lat', 'old_population_percentage', 'district_exit_percent']
...
station_score['adjusted_demand'] = station_score['old_population_percentage'] * station_score['district_exit_percent']
